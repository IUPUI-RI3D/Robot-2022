...
public class RaiseIntakeCommand extends CommandBase {
  private final IntakeActuatorSubsystem intakeActuatorSubsystem;
  /** Creates a new RaiseIntakeCommand. */
  public RaiseIntakeCommand(final IntakeActuatorSubsystem subsystem) {
  ...
  @Override
  public void execute() {
    intakeActuatorSubsystem.raiseIntake();
  }
